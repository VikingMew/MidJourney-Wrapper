import discord
import Globals
from Salai import MaxUpscale, PassPromptToSelfBot, Upscale, Variation
...
@bot.command(
    description="Upscale to max targetted image (should be already upscaled using mj_upscale)"
)
